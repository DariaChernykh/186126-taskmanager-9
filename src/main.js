...
const getCardsBoard = () => `<div class="board__tasks"></div>`;

const getCard = () => ` <article class="card card--black">
...
const createContainer = () => `<section class="board container"></section>`;

const getBtnMore = () => `<button class="load-more" type="button">load more</button>`;
